public class Manutencao {
     ...
     * @param manutencaoPeriodica parâmetro do tipo int que indica a quilometragem 
     * em que é feita a manutenção periódica.
    ...
    /**
     * Método para verificar se um veículo necessita de manutenção. Verifica a
     * partir da quantidade de
     * manutenções realizadas e quantas são necessárias para o veículo a partir dos
     * quilometros rodados.
     * 
     * @param kmTotalAtual
    ...
    public boolean verificarManutencao(double kmTotalAtual) {
        ...
        if ((int) (kmTotalAtual / kmPeca) > quantidadeManutencaoPeca
                || (int) (kmTotalAtual / kmPeriodica) > quantidadeManutencaoPeriodica) {
            return true;
        } else {
            return false;
        }
    ...
    /**
     * Método que realiza a manutenção no veículo, quantifica quantas manutenções
     * foram
     * realizadas
     * 
     * @param kmTotalAtual
